// Adds the 'retention' value to the Widget.type enum so the new "Retention"
// widget (recurring-visitor rate) can be created.
//
...
async function up({ context: queryInterface }) {
    await queryInterface.sequelize.query(
        `ALTER TYPE "enum_Widgets_type" ADD VALUE IF NOT EXISTS 'retention';`,
    );
}
