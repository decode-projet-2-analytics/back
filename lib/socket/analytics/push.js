...
const { aggregateRetention } = require('../../aggregations/retention');
...
async function computeWidgetPayload(widget) {
    switch (widget.type) {
        ...
        case 'breakdown':
            return aggregateBreakdown(widget);
        case 'scroll_depth':
            return aggregateScrollDepth(widget);
        case 'retention':
            return aggregateRetention(widget);
        default:
            return null;
    }
}
