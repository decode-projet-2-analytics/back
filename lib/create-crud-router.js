 ...
 * @param {object|Function} [options.listScope] - Optional scope used only for collection reads
 ...
 * @param {object} [options.hooks] - beforeCreate, beforeUpdate, beforePatch, beforeDelete, afterCreate, afterPatch, listOptions, getOptions
